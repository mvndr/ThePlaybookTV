(function(a) {
    ...
    function z(b) {
        ...
        a(b).find(".dataTables_info span.infoRows").text(c)
    }

    function A(b, c, d, f, h, e, g) {
        a(b).find("table").dataTable({
            retrieve: !0,
            paging: !1,
            aaSorting: [],
            scrollX: !0,
    ...
    function u(b) {
        $ID = a(b).attr("id") + "-svg-gradient";
        a(b).find("svg linearGradient").attr("id", $ID);
        a(b).find("svg.gradient-element").each(function() {
            a(this).attr("stroke", "url(#" + $ID + ")");
            a(this).attr("fill",
                "url(#" + $ID + ")")
        })
    ...
    function C(b, c) {
        b.animate({
            "background-position": -a(window).width()
        }, c, "linear", function() {
            a(this).css({
    ...
    function v(b, c) {
        a(c).typed({
            strings: b,
            typeSpeed: 101 - parseInt(a(c).attr("data-speed")),
            backSpeed: 101 - parseInt(a(c).attr("data-speed")),
            loop: !0,
            backDelay: 1E3
        })
    }
    ...
    function w(b, c, d) {
        a(b).stop();
        var f = a(b).find(".animated-element");
        f.text(c);
        f.css({
            "white-space": "nowrap",
            "z-index": 0
    ...
    (function(a, c) {
        var d = function(a, b, c) {
            ...
            return function() {
                var e = this,
                    D = arguments;
                d ? clearTimeout(d) : c && a.apply(e, D);
    ...
    a(function() {
                ...
                if (c && (/youtube/g.test(c[3]) || /vimeo/g.test(c[3])))
                    if (c && /youtube/g.test(c[3])) b =
                        "http" + ("https:" === location.protocol ? "s" : "") + ":", b += "//img.youtube.com/vi/" + c[6] + "/maxresdefault.jpg", a("<img>").on("load", function() {
                            ...
                            b), !a.fn.YTPlayer || e || a.isMobile() || a("> *:eq(1)", this).before('<div class="mbr-background-video"></div>').prev().YTPlayer({
                            videoURL: c[6],
                            containment: "self",
                            showControls: !1,
                            mute: !0
                            ...
                            f.onreadystatechange = function() {
                                if (4 === this.readyState)
                                    if (200 <= this.status && 400 > this.status) {
                                        ...
                                        d.css("background-image", 'url("images/no-video.jpg")').show()
                            };
                            f.send();
                            f = null;
        ...
        a(window).scroll(function() {
            a(".mbr-navbar--sticky").each(function() {
                var b = 10 < a(window).scrollTop() ? "addClass" :
                    "removeClass";
        ...
        }(a(window).width(), a(window).height()) : F || (a(window).smartresize(function() {
        ...
        a(document).on("changeParameter.cards", function(b, c, f, e) {
            if ("bg" === c) switch (e) {
                case "type":
                    ...
                    break;
                case "value":
                    "video" === f.type && (a(b.target).find(".mbr-background-video-preview").remove(), d(b.target))
            }
        });
                ...
                d.on("scroll resize", function() {
                    ...
                    a.each(c, function() {
                        var c = a(this),
                            ...
                            k = g.offsetHeight,
                            g = b(g);
                        if (g + k >= d && g <= e && c.hasClass("hidden")) c.removeClass("hidden").addClass("fadeInUp").one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function() {
        ...
        if (!e) {
            var b = function(b) {
                var d = a(b).parents("section").find("iframe")[0],
                    f = a(d).attr("src");
                b.parents("section").css("z-index", "1"); - 1 !== f.indexOf("youtu") && d.contentWindow.postMessage('{"event":"command","func":"playVideo","args":""}', "*");
                if (-1 !== f.indexOf("vimeo")) {
                    var e = new Vimeo.Player(a(d));
                    e.play()
                }
                a(b).parents("section").find(a(b).attr("data-modal")).css("display", "table").click(function() {
                    -1 !== f.indexOf("youtu") && d.contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}', "*"); - 1 !== f.indexOf("vimeo") && e.pause();
    ...
    if (!e && !a.isMobile()) {
        var k = a("section.menu"),
            G = a(window).width();
        !k.find(".navbar").hasClass("collapsed") && 991 < G && (k.find("ul.navbar-nav li.dropdown").hover(function() {
    ...
    if (e) a(document).on("add.cards", function(b) {
        a(".pie_progress").length && n(b.target)
    ...
    if (e) a(document).on("add.cards", function(b) {
        0 != a(".countdown").length && p()
    }).on("changeParameter.cards", function(b, c, d) {
        "countdown" === c && (b = a(b.target).find(".countdown"), -1 < d.search(/\d\d\d\d\/\d\d\/\d\d/g) && (b.removeClass("countdown-inited"), p()))
    });
    else 0 != a(".countdown").length && p();
    if (e) a(document).on("add.cards", function() {
        0 != a(".flip-card").length && E()
    });
    if (e) a(document).on("add.cards", function(a) {
        x(a.target)
    });
    ...
    if (e) a(document).on("add.cards", function(b) {
        ...
        "testimonialsSlides" === c && 0 == a(b.target).find(".carousel-item.active").length && q(b.target)
    });
    ...
    if (e) a(document).on("add.cards", function(b) {
        ...
        "slidesCount" == c && 0 == a(b.target).find(".carousel-item.active").length && q(b.target);
        r(b.target);
        t(b.target);
        a(b.target).find(".carousel-item [mbr-media]").on("click", function(a) {
            m(a)
    ...
    if (e) a(document).on("add.cards", function(b) {
        ...
        if (b) {
            var c = a(this).find(".dataTables_info span.infoBefore").text(),
                d = a(this).find(".dataTables_info span.infoAfter").text(),
                f = a(this).find(".dataTables_info span.infoFilteredBefore").text(),
                e = a(this).find(".dataTables_info span.infoFilteredAfter").text();
            searchText = a(this).find(".dataTables_filter label.searchInfo").text();
            infoClasses = a(this).find(".dataTables_info").attr("class").split(/\s/);
            searchClasses = a(this).find(".dataTables_filter label.searchInfo").attr("class").split(/\s/);
            displayInfoFont = B(infoClasses);
            displayFilterFont = B(searchClasses);
            a(this).find(".row.search").remove();
            a(this).find(".table-wrapper .scroll").removeClass("scroll");
            a(this).find(".row.info").remove();
            A(a(this), b, searchText, c, d, f, e);
            a(this).find(".dataTables_info").addClass(displayInfoFont);
            a(this).find(".dataTables_filter label").addClass(displayFilterFont)
        } else a(this).find(".row.search").remove(), a(this).find(".table-wrapper .scroll").removeClass("scroll"), a(this).find(".row.info").remove(), A(a(this), b)
    });
    e || 0 != a("section.popup-btn-cards").length && a("section.popup-btn-cards .card-wrapper").each(function(b, c) {
        a(this).addClass("popup-btn")
    });
    if (e) a(document).on("add.cards",
        function(b) {
            a(b.target).hasClass("svg-gradient-elements") && u(b.target)
        }).on("changeParameter.cards", function(b) {
        a(b.target).hasClass("svg-gradient-elements") && u(b.target)
    });
    else a("section.svg-gradient-elements").each(function() {
        u(a(this))
    });
    if (e) a(document).on("add.cards", function(b) {
        a(b.target).hasClass("scroll-background") && C(a(b.target), 5E4)
    });
    else 0 != a(document).find(".scroll-background").length && a(".scroll-background").each(function() {
        C(a(this), 5E4)
    });
    if (e) a(document).on("add.cards", function(b) {
        0 !=
            a(b.target).find(".typed-text").length && a(b.target).find(".animated-element").each(function() {
                for (var b = parseInt(a(this).attr("data-words")), d = [], f = 1; f <= b; f++) {
                    var e = "data-word" + f;
                    "undefined" != typeof a(this).attr(e) && d.push(a(this).attr(e))
                }
                v(d, a(this))
            })
    }).on("changeParameter.cards", function(b, c, d) {
        0 != c.indexOf("animatedWord") && "typeSpeed" != c && "wordsCount" != c || a(b.target).find(".animated-element").each(function() {
            for (var b = parseInt(a(this).attr("data-words")), c = [], d = 1; d <= b; d++) {
                var e = "data-word" +
                    d;
                "undefined" != typeof a(this).attr(e) && c.push(a(this).attr(e))
            }
            v(c, a(this))
        })
    });
    else a(".typed-text .animated-element").each(function() {
        for (var b = parseInt(a(this).attr("data-words")), c = [], d = 1; d <= b; d++) {
            var e = "data-word" + d;
            "undefined" != typeof a(this).attr(e) && c.push(a(this).attr(e))
        }
    ...
    e ? (a(document).on("delete.cards", function(b) {
            0 != a(b.target).find(".animated-text-background").length && (b = a(b.target).find(".animated-text-background").attr("id"), b = parseInt(b.substr(8)), clearInterval(b))
        }),
        a(document).on("add.cards", function(b) {
            0 != a(b.target).find(".animated-text-background").length && a(b.target).find(".animated-text-background").each(function() {
                var b = 1E3 * (101 - parseInt(a(this).find(".animated-element").attr("data-speed"))),
                    d = a(this).find(".animated-element").attr("data-word");
                w(a(this), d, b)
            })
        }).on("changeParameter.cards", function(b, c, d) {
            "animatedText" != c && "textSpeed" != c && "textTitle" != c && "textSize" != c || a(b.target).find(".animated-text-background").each(function() {
                var b = 1E3 * (101 - parseInt(a(this).find(".animated-element").attr("data-speed"))),
                    c = a(this).find(".animated-element").attr("data-word"),
                    d = a(this).attr("id"),
                    d = parseInt(d.substr(8));
                clearInterval(d);
                a(this).clearQueue();
                w(a(this), c, b)
            })
        })) : a(".animated-text-background").each(function() {
        var b = 1E3 * (101 - parseInt(a(this).find(".animated-element").attr("data-speed"))),
            c = a(this).find(".animated-element").attr("data-word");
        w(a(this), c, b)
    })
